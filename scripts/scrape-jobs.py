"""Scrape a fresh chunk of genuine Swiss Spengler jobs into JSON.
...
from job_safety import CONFIG as JOB_SAFETY_CONFIG, classify_spengler_title
...
def is_relevant_job(job: dict) -> bool:
    """Return True only for clearly Spengler-related Swiss roles."""
    ...
    return classify_spengler_title(title)["disposition"] == "ACCEPT"
...
DEFAULT_SEARCH_TERMS = [
    ...
    "Bauleiter Spenglerei",
    "AVOR Spenglerei",
    "Planer Spenglerei",
    "Spengler Gebäudehülle",
    "Spengler Flachdach",
    "Spengler Blechbearbeitung",
]
...
def main():
    parser = argparse.ArgumentParser(description="Scrape Swiss Spengler jobs")
