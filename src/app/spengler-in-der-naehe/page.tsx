...
export const metadata: Metadata = {
  ...
  description:
    "Spenglerstellen nach ausgewählten Schweizer Städten und Regionen durchsuchen.",
  alternates: { canonical: "/spengler-in-der-naehe" },
  openGraph: {
    title: "Spengler in der Nähe | Jobs in deiner Stadt finden",
    description: "Spenglerstellen nach ausgewählten Schweizer Städten und Regionen durchsuchen.",
    url: "/spengler-in-der-naehe",
    type: "website",
  },
  twitter: {
