...
const homepageMetadata: Metadata = {
  ...
  description:
    "Finde Stellenangebote für Spengler EFZ, Bauspenglerei, Flachdach, Gebäudehülle, AVOR und Projektleitung in der Schweiz.",
          ...
          <section className={`trade-hero relative z-20 overflow-visible ${hasActiveSearch ? "pb-5 pt-8 sm:pb-7 sm:pt-10 md:pt-12" : "pb-6 pt-10 sm:pb-9 sm:pt-14 md:pt-20"}`}>
            <div className="container mx-auto max-w-6xl px-4 sm:px-6">
              <div className="trade-hero-grid">
                <div>
                  <p className="trade-kicker">Spengler · ganze Schweiz</p>
                  <h1 className="trade-display">
                    <span className="block">Spengler</span><span className="block">jobs.</span><em>Präzise gefunden.</em>
                  </h1>
                  <p className="mt-5 max-w-2xl text-sm leading-relaxed text-muted-foreground sm:text-lg">
                    Stellen für Bauspenglerei, Gebäudehülle, Flachdach, Metallbekleidung, Werkstatt und Projektleitung. Direkt nach Beruf, Ort und Pensum filtern.
                  </p>
                </div>
                <div className="sheet-fold" aria-hidden="true"><span className="sheet-fold__label">Falz 07 / Stellenraster CH</span></div>
              </div>
