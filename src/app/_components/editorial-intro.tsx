...
import type { EditorialContent } from "@/data/editorial/spenglerjob";
import { EDITORIAL_BYLINE } from "@/data/editorial/spenglerjob";

interface EditorialIntroProps {
  /** Display label for the role, e.g. "Spengler EFZ" */
  role: string;
