...
export const metadata: Metadata = {
  ...
  description: "Die gewünschte Seite konnte nicht gefunden werden. Finde aktuelle Spenglerjobs auf spenglerjob.ch.",
  robots: {
    index: false,
    follow: true,
  },
      ...
      <main className="flex-1 flex items-center justify-center px-4">
        <div className="text-center max-w-lg">
          ...
          <p className="text-slate-600 mb-8">
            ...
            Nutze die Suche, um aktuelle Spenglerjobs zu finden.
          </p>
