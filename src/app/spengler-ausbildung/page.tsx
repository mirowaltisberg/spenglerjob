...
export const metadata: Metadata = {
  title: "Spengler Ausbildung Schweiz | Lehre, EFZ, EBA & Weiterbildung",
  description:
    "Alles zur Spengler Ausbildung in der Schweiz: Lehre (Polybauer EFZ Spenglerei), Lehrstellen, Lohn, Berufsschule, EBA und Weiterbildungen — kompakter Guide 2026.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Spengler Ausbildung", item: `${SITE_URL}/spengler-ausbildung` },
  ],
};

const FAQS = [
  {
    question: "Wie lange dauert die Spengler Lehre in der Schweiz?",
    answer:
      "Die Grundbildung Polybauer EFZ Spenglerei dauert 3 Jahre. Sie schliesst mit dem eidgenössischen Fähigkeitszeugnis (EFZ) ab — der schweizweit anerkannte Berufsabschluss. Alternativ gibt es die kürzere Ausbildung Polybaupraktiker EBA (2 Jahre), die mehr auf praktische Tätigkeiten fokussiert.",
  },
  {
  ...
  {
    question: "Wie viel verdient ein Spengler nach der Lehre?",
    answer:
      "Direkt nach der Lehre verdienst du als ausgebildeter Spengler typischerweise zwischen CHF 60'000 und CHF 75'000 pro Jahr. Mit drei bis fünf Jahren Erfahrung und ersten Spezialisierungen verschiebt sich der Lohn auf CHF 75'000 bis CHF 95'000. Detaillierte Lohnübersichten findest du auf unserer Seite Lohn Spengler Schweiz.",
  },
];
        ...
        <section className="bg-primary/5 border-b">
          <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 max-w-4xl">
            ...
            <h1 className="text-3xl sm:text-5xl font-black text-slate-900 leading-tight mb-4">
              Spengler Ausbildung <span className="text-primary">Schweiz</span>
            </h1>
            <p className="text-slate-600 text-lg leading-relaxed max-w-3xl">
              Dein Guide zur Spengler Lehre in der Schweiz — Voraussetzungen, Dauer, Lohn, Berufsschule und Weiterbildungswege. Stand 2026.
            </p>
          </div>
        </section>

        <section className="container mx-auto px-4 sm:px-6 py-10 max-w-4xl">
          <h2 className="text-2xl font-bold text-slate-900 mb-4">Die Lehre Polybauer EFZ Spenglerei</h2>
          <p className="text-slate-600 mb-3 leading-relaxed">
            Die Grundbildung Polybauer EFZ Spenglerei dauert 3 Jahre und schliesst mit dem eidgenössischen Fähigkeitszeugnis (EFZ) ab. Der Lehrbetrieb übernimmt die praktische Ausbildung, die Berufsfachschule den schulischen Teil (1 bis 2 Tage pro Woche) und die überbetrieblichen Kurse (üK) ergänzen mit Spezialthemen.
          </p>
          <p className="text-slate-600 mb-3 leading-relaxed">
