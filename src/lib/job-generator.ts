...
const DEFAULT_QUERY = "Spengler EFZ";
...
const RESPONSIBILITY_TEMPLATES = [
  "Anfertigung und Montage von Blechabdeckungen und Dachrinnen.",
  "Erstellen von Kamineinfassungen und Blechanschlüssen.",
  "Montage von Fassadenverkleidungen aus Metall.",
  "Abdichtungsarbeiten an Flachdächern und Terrassen.",
  ...
  "Montage von Dachrandabschlüssen und Entwässerungssystemen.",
];
...
const REQUIREMENT_TEMPLATES = [
  ...
  "Erfahrung mit verschiedenen Blecharten und Verarbeitungstechniken.",
...
function buildGeneratedJob(
  ...
  const focusText = primaryFocus
    ...
    : "mit Fokus auf moderne Spenglerprojekte";
